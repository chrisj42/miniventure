...
public final class MyUtils {
	...
	public static void fillRect(float x, float y, float width, float height, Color c, Batch batch) {
		...
		batch.setColor(c);
		batch.draw(GdxCore.icons.get("white").texture, x, y, width, height);
		batch.setColor(prev);
	}
	...
	public static EnumSet<TileType> enumSet(Collection<TileType> collection) {
		return enumSet(TileType.class, collection);
	}
	public static EnumSet<TileType> enumSet(TileType[] items) {
		return enumSet(TileType.class, items);
	}
