...
public class InfoScreen extends MenuScreen {
	...
	private InfoScreen(boolean addButton, String... text) {
		...
		if(addButton) {
			cont = makeButton("Continue to World Config", () -> GdxCore.setScreen(new WorldGenScreen()));
			table.add(cont);
		}
		
		VisTextButton back = makeButton("Back", GdxCore::backToParentScreen); 
		table.add(back).row();
	...
	public static class InstructionsScreen extends InfoScreen {
		...
		/*@Override
		public void focus() {
			RenderCore.viewedInstructions = true;
		}*/
	}
