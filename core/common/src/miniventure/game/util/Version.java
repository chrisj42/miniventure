...
public class Version implements Comparable<Version> {
	...
	public static final Version CURRENT = makeVersion("2.2.1.6");
	
	// the last time there was a change in the save format
	private static final Version latestFormatChange = makeVersion("2.2.1.6");
	...
	static {
		...
		endOfSupportVersions.put(makeVersion("2.2.1.6"), CURRENT);
